  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-4 sm:mb-6 gap-2">
        ...
        <button
          onClick={startNew}
          className="px-3 sm:px-4 py-2 bg-felt hover:bg-felt-dark text-white rounded-lg text-sm font-medium flex items-center gap-2 flex-shrink-0"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-[280px_1fr] gap-4 md:gap-6">
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-3 max-h-[40vh] md:max-h-[75vh] overflow-y-auto">
          {loading ? (
