...
export function SetupPage() {
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-1 sm:gap-2 mb-6 sm:mb-8 overflow-x-auto no-scrollbar -mx-4 px-4 sm:mx-0 sm:px-0">
        {steps.map((s, i) => (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6">
            <div className="flex items-center justify-between mb-3 gap-2">
              ...
              <button
                ...
                className="px-3 py-1.5 bg-gray-800 hover:bg-gray-700 text-gray-300 rounded-lg text-xs font-medium flex items-center gap-1 flex-shrink-0"
              >
          ...
          <div className="flex justify-end">
            <button
              ...
              className="w-full sm:w-auto px-6 py-3 sm:py-2.5 bg-felt hover:bg-felt-dark text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
            >
      ...
      {step === 1 && tournament && (
        <div className="space-y-6">
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6">
            ...
            <div className="flex gap-2 mb-4">
              <input
                ...
                className="flex-1 min-w-0 px-3 sm:px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-felt text-sm"
              />
              <button
                onClick={handleAddNewPlayer}
                disabled={!newPlayerName.trim()}
                className="px-3 sm:px-4 py-2 bg-felt hover:bg-felt-dark disabled:opacity-50 text-white rounded-lg text-sm font-medium transition-colors flex items-center gap-1 flex-shrink-0"
              >
                <Plus className="w-4 h-4" /> <span className="hidden sm:inline">Add</span>
              </button>
            </div>

            <div className="space-y-1 max-h-[60vh] sm:max-h-96 overflow-y-auto">
              {players.map((p) => (
                <button
                  key={p.id}
          ...
          <div className="flex gap-3">
            <button
              onClick={() => setStep(0)}
              className="flex-1 sm:flex-none px-4 sm:px-6 py-3 sm:py-2.5 bg-gray-800 hover:bg-gray-700 text-gray-300 rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
            >
            ...
            <button
              ...
              className="flex-1 sm:flex-none sm:ml-auto px-4 sm:px-6 py-3 sm:py-2.5 bg-felt hover:bg-felt-dark disabled:opacity-50 text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
            >
              Next <ChevronRight className="w-4 h-4" />
            </button>
          </div>
      ...
      {step === 2 && tournament && (
        <div className="space-y-6">
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6">
            <div className="flex items-center justify-between mb-4 gap-2">
              ...
              <button
                ...
                className="px-3 sm:px-4 py-2 bg-felt hover:bg-felt-dark text-white rounded-lg text-sm font-medium transition-colors flex items-center gap-2 flex-shrink-0"
              >
                <Shuffle className="w-4 h-4" /> <span className="hidden sm:inline">Shuffle All</span><span className="sm:hidden">Shuffle</span>
              </button>
            </div>
            ...
            <p className="text-xs text-gray-400 mb-4">
              ...
              Tap &quot;Shuffle&quot; to randomly assign seats, or start the game and arrange manually.
            </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              onClick={() => setStep(1)}
              className="px-4 sm:px-6 py-3 sm:py-2.5 bg-gray-800 hover:bg-gray-700 text-gray-300 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 sm:order-1"
            >
              <ChevronLeft className="w-4 h-4" /> Back
            </button>
            <button
              ...
              className="px-6 sm:px-8 py-3 sm:py-3 bg-gold hover:bg-gold-light disabled:opacity-50 text-gray-900 rounded-lg font-bold text-base sm:text-lg transition-colors sm:order-2 sm:ml-auto"
            >
